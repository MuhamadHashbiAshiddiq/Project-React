    ...
    return (
      <main className="form-signin">
        <form onSubmit={this.submit}>
          ...
          <input type="First Name" className="form-control" placeholder="First Name" required onChange={(e) => (this.first_name = e.target.value)} />

          <input type="Last Name" className="form-control" placeholder="Last Name" required onChange={(e) => (this.last_name = e.target.value)} />
